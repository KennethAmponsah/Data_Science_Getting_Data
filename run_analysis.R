setwd("C:/Users/Boateng/Desktop/Coursera/data science/gettin data")
...
print("mydata present")
  download.file(url, mydata, method="curl")
}
...
if(!file.exists(datafolder)){
  print("unzip mydata")
  unzip(mydata, list = FALSE, overwrite = TRUE)
} 
